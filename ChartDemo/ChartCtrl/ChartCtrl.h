...
public:
	...
	CChartStandardAxis* CreateSpecialAxis(int num);
	...
	**/
	CChartStandardAxis* CreateStandardAxis(EAxisPos axisPos, int num);
...
private:
	...
	**/
	...
	//! The five axis of the control.
	CChartAxis* m_pAxes[8];
